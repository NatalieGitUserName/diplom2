...
let PersonalPage = () => {
    ...
    if (userCopy.firstName == null) {userCopy.firstName = ''}
        ...
        <div className={s.container}>
            ...
            <div className={s.infoBlockContainer}>
                <div className={s.infoBlock}>
                    <div className={s.avatar} style={{backgroundImage: user.photo !== null ? `url(${user.photo})` : `url(${profile})`}}></div>
            ...
            <div className={s.changeInfoContainer}>
                <div className={s.changeInfo}>
                    ...
                    <input type="text" value={persInfo.firstName} onChange={(e) => {setPersInfo({...persInfo, firstName: e.target.value})}}/>
                    <button onClick={() => {saveFirstName()}}>Save first name</button>
                    <br/>
                    <span>Change first name</span>
                    <input type="text" value={persInfo.secondName} onChange={(e) => {setPersInfo({...persInfo, secondName: e.target.value})}}/>
                    <button onClick={() => {saveSecondName()}}>Save second name</button>
                    <br/>
                    <span>Change third name</span>
                    <input type="text" value={persInfo.thirdName} onChange={(e) => {setPersInfo({...persInfo, thirdName: e.target.value})}}/>
                    <button onClick={() => {saveThirdName()}}>Save third name</button>
                    <br/>
                    <span>Change photo</span>
                    <input type="file" onChange={(e) => {photoLoad(e).then()}}/>
                    <button onClick={() => {savePhoto()}}>Save photo</button>
                    <br/>
                    <span>Change birthday</span>
                    <input type="date" onChange={(e) => {setPersInfo({...persInfo, birthday: e.target.value})}}/>
